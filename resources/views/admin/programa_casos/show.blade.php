...
@php
    ...
    if ($fuente === 'Encuesta') {
        $alertaEncuesta = \App\Models\EncuestaAlerta::where('empleado_id', $entry->empleado_id)
            ...
            ->first();
        if ($alertaEncuesta) {
            $respuestaEncuesta = \App\Models\EncuestaRespuesta::with(['items.pregunta', 'items.opcion', 'encuesta'])
...
@section('header')
    <div class="container-fluid d-flex justify-content-between my-3">
        <section class="header-operation animated fadeIn d-flex mb-2 align-items-baseline" bp-section="page-header">
            <h1 class="text-capitalize mb-0" bp-section="page-heading">Caso por evaluar</h1>
            <p class="ms-2 ml-2 mb-0" bp-section="page-subheading">{{ $entry->programa?->nombre }}</p>
            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <dl class="row mb-0">
                        ...
                        <dd class="col-8">{{ $entry->empleado?->telefono }}</dd>
                        <dt class="col-4">Correo</dt>
                        <dd class="col-8">{{ $entry->empleado?->correo_electronico }}</dd>
                    </dl>
                </div>
                <div class="col-md-4">
        ...
        @if ($fuente === 'Encuesta')
            <div class="card p-4">
                ...
                @else
                    ...
                    <div class="text-muted">Usa el botón “Ver resultados” para ver el detalle por pregunta.</div>
                @endif
            </div>
        @else
            <div class="card p-4">
                <h5 class="mb-3">Información de incapacidad</h5>
