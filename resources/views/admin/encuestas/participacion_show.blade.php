...
@php
    ...
    $entry->loadMissing(['encuesta', 'empleado.cliente', 'empleado.sucursal', 'items.pregunta', 'items.opcion', 'envio']);
@endphp
...
@section('header')
    <div class="container-fluid d-flex justify-content-between my-3">
        <section class="header-operation animated fadeIn d-flex mb-2 align-items-baseline" bp-section="page-header">
            ...
            <p class="ms-2 ml-2 mb-0" bp-section="page-subheading">{{ $entry->encuesta?->titulo }}</p>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <dl class="row mb-0">
                        ...
                        <dt class="col-4">Enviado</dt>
                        <dd class="col-8">{{ optional($entry->created_at)->format('Y-m-d H:i') }}</dd>
                        <dt class="col-4">Respondido</dt>
                        <dd class="col-8">{{ optional($entry->respondido_en)->format('Y-m-d H:i') ?: '—' }}</dd>
                        <dt class="col-4">Link</dt>
                        <dd class="col-8">
                            <a href="{{ url('/encuestas/' . $entry->token) }}" target="_blank">Ver link</a>
                        </dd>
                    </dl>
                </div>
                <div class="col-md-4">
                    ...
                    <dl class="row mb-0">
                        ...
                        <dd class="col-7">{{ $entry->puntaje_total ?? 0 }}</dd>
                    </dl>
                </div>
            </div>
        </div>
