@php
  ...
  $caseIndicators = $crud->getOperationSetting('case_indicators');
@endphp
  ...
  <div class="col-md-4">
    <div class="card border-0 shadow-sm">
      <div class="card-body py-2">
        <div class="text-muted small">Casos confirmados</div>
        <div class="h4 mb-0">{{ $caseIndicators['confirmados'] ?? 0 }}</div>
      </div>
    </div>
  </div>
  <div class="col-md-4">
    <div class="card border-0 shadow-sm">
      <div class="card-body py-2">
        <div class="text-muted small">Casos probables</div>
        <div class="h4 mb-0">{{ $caseIndicators['probables'] ?? 0 }}</div>
      </div>
    </div>
  </div>
  <div class="col-md-4">
    <div class="card border-0 shadow-sm">
      <div class="card-body py-2">
        <div class="text-muted small">Personas activas</div>
        <div class="h4 mb-0">{{ $caseIndicators['activos'] ?? 0 }}</div>
      </div>
    </div>
  </div>
</div>
